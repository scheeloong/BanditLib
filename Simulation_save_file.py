...
if __name__ == '__main__':
    ...
    parser.add_argument(
        ...
        dest='alg',
        help=
        'Select a specific algorithm, could be LinUCB, CoLin, hLinUCB, factorUCB, etc.'
    )
    ...
    parser.add_argument(
        '--userNum',
        dest='userNum',
        help='Set the userNum, for example 40, 80, 100')
    parser.add_argument(
        '--Sparsity',
        dest='SparsityLevel',
        help=
        'Set the SparsityLevel by choosing the top M most connected users, should be smaller than userNum, when equal to userNum, we are using a full connected graph'
    )
    parser.add_argument(
    ...
    parser.add_argument(
        ...
        type=int,
        help=
        'Set dimension of hidden features. This argument is only for algorithms that can estimate hidden feature'
    )
