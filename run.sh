...
#python Simulation.py --alg HybridLinUCB
#python Simulation.py --alg GOB.Lin # Empty
#python Simulation.py --alg UCBPMF
#python Simulation.py --alg hLinUCB
#python Simulation.py --alg All --contextdim 15 --hiddendim 15
#python Simulation.py --alg All  --contextdim 5 --hiddendim 5
#python Simulation_r2bandit.py --alg CoLin
#python Simulation_r2bandit.py --alg GOB.Lin
