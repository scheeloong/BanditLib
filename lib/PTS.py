...
class PTSParticleStruct:
    def __init__(self,
        ...
        self.users = []
        for i in range(n):
            self.users.append(PTSUserStruct(
                i,
                dimension,
                sigma,
                sigmaU,
...
class PTSAlgorithm:
    def __init__(
        ...
        for i in range(particle_num):
            self.particles.append(
                PTSParticleStruct(dimension, n, itemNum, sigma, sigmaU, sigmaV,
                                  1.0 / particle_num))
    ...
    def decide(self, pool_articles, userID):
        ...
        #Sample a Particle
        d = np.random.choice(
            self.particle_num, p=[p.weight for p in self.particles])
        p = self.particles[d]
        #For PTS-B
    ...
    def updateParameters(self, articlePicked, click, userID):
        ...
        #Resampling
        self.particles = [
            self.particles[i] for i in np.random.choice(
