...
LastFM_FeatureVectorsFileName = os.path.join(LastFM_address,
                                             'Arm_FeatureVectors_2.dat')
LastFM_relationFileName = os.path.join(LastFM_address,
                                       'user_friends.dat.mapped')

Delicious_FeatureVectorsFileName = os.path.join(Delicious_address,
                                                'Arm_FeatureVectors_2.dat')
Delicious_relationFileName = os.path.join(Delicious_address,
                                          'user_contacts.dat.mapped')

Yelp_save_address = "./YelpResults"
Yelp_address = '../../../Yelp'
Yelp_FeatureVectorsFileName = os.path.join(Yelp_address,
                                           'Arm_FeatureVectors_2.dat')
